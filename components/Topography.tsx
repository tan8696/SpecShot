...
// Adapted from reactbits.dev "Topography" (JS + CSS variant). Ported to TSX:
// "use client", typed props, the 4-line container CSS folded into Tailwind
// classes so no CSS-module file is needed. Renders a morphing contour-line
// field on a full-bleed WebGL2 canvas; pauses itself when offscreen or the
// tab is hidden.
